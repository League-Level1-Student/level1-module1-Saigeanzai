...
public class TurfWar extends PApplet {
	...
	class Player {
		 ...
		 * parameters and initializes them using the this keyword.
		 */
		...
		/*
		 * The member variables below do not need to be initialized in the constructor.
		 */
		...
		void drawPlayer() {
			/*
			 * 2. Draw a rectangle to represent the the Player using its color, coordinates
			 * and size.
			 */
		...
		void update() {
			/*
			 * This piece of codes makes the player move up without leaving the bounds of
			 * the sketch if its up key is pressed.
			 * 
			 * Note: statsBoardLine is used instead of 0 because that is where the area
			 * detailing game stats(timer, score, etc.) ends.
			 * 
			 */
			 ...
			 *
			 * Note: You do not need to use the statsBoardLine for the other directions.
			 */
	...
	/*
	 * 4. Declare two variables of the Player class called player1 and player2. Do
	 ...
	 * the game will run for 30 seconds (30000 milliseconds).
	 */
	int endOfGame = 30000;
	...
	public void setup() {
		/*
		 * Do not change this code. It makes it so you can press the keys to control the
		 * Players without clicking on the window first.
		 */
		 ...
		 * the keys, for the second use the W,A,S,D final int variables created above.
		 * 
		 ...
		 * 
		 * Note: Use the Color class for the color, e.g. Color.BLUE.getRGB(). Do not
		 * select black, white or the color you used for your background as it will give
		 * that player an unfair advantage.
		 */

		player1 = new Player(150, 150, 25, 10, Color.red.getRGB(), UP, LEFT, DOWN, RIGHT);
		player2 = new Player(155, 155, 25, 10, Color.GREEN.getRGB(), W, A, S, D);
...
player2.disableMovement(keyCode);
	...
	/*
	 * 17. Try to play a game of Turf War with someone nearby if possible. The goal
